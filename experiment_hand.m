...
FRAMENUM    =  [9:34]; %[1,2,54,55]
IMAGES_PATT = 'data/hand/frames/f%03d.png';
MASKS_PATT  = 'data/hand/mask/m%03d.png';
FLOW_FW_PATT= 'data/hand/OFD/flowsARSfwd%03d.mat';
FLOW_BW_PATT= 'data/hand/OFD/flowsARSbwd%03d.mat';
OCC_FW_PATT = 'data/hand/OFD/occ_gbve_fw%03d.png'; 
OCC_BW_PATT = 'data/hand/OFD/occ_gbve_bw%03d.png'; 
OUT_DIR     = 'data/hand/results/';
LIDS        = 'BOTH';  % 'FIRST' 'LAST', 'BOTH'
...
params.LAMBDA=0.01;            % SPATIAL REGULARITY 0.02    ONLY FOR FWBW_* 
