...
FRAMENUM    =  [1:55]; %[1,2,54,55]
IMAGES_PATT = 'data/cloth/input_color/frame_%03d.png';
MASKS_PATT  = 'data/cloth/msk/msk_%03d.png';
FLOW_FW_PATT= 'data/cloth/OFD/fw_%03d.mat';
FLOW_BW_PATT= 'data/cloth/OFD/bw_%03d.mat';
%OCC_FW_PATT = 'data/cloth/OFD/occ_gbve_fw%03d.png'; 
%OCC_BW_PATT = 'data/cloth/OFD/occ_gbve_bw%03d.png'; 
OUT_DIR     = 'data/cloth/results/';
